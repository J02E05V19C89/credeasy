        ...
        <script>
            $(function () {
                ...
                $("#nuevo").on("click", function () {
                    $.get("<? echo base_url('Principal/buscarNCredito') ?>", function (data) {
                        //console.log(data);
            ...
            <div id="mod_clientes">
                <div class="container">
                    <div class="row">
                        ...
                        <?
                        //echo $contenido;
                        echo form_open(base_url() . "Principal/reg_mod_creditos")
                        ?>
                        ...
                        <div class="col-xs-12 col-sm-4">  
                            <div class="form-group">
                                <label for="cbotipocredito">Tipo Credito</label>
                                <select class="form-control" name="cbotipocredito" id="cbotipocredito" disabled="disabled">
                                    <?
                                    foreach ($resultadoConsulta->result() as $filaCredito) {
                                        echo "<option value='" . $filaCredito->CodigoCredito . "'>" . $filaCredito->Descripcion . "</option>";
                                    }
                                    ?>
                                </select>            
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-4">  
                            <div class="form-group">
                                <label for="cbotipoproducto">Producto</label>
                                <select class="form-control" name="cbotipoproducto" id="cbotipoproducto" disabled="disabled">
                                    <?
                                    foreach ($resultadoConsulta2->result() as $filaProducto) {
                                        echo "<option value='" . $filaProducto->idproducto . "'>" . $filaProducto->descripcion . "</option>";
                                    }
                                    ?>
                                </select>                 
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-3">  
                            <div class="form-group">
                                ...
                                <input id="txtcliente" name="txtcliente" type="text" class="form-control" disabled="disabled" />              
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-3">  
                            <div class="form-group">
                                <label for="txtvalor">Valor nuevo credito</label>
                                <input id="txtvalor" name="txtvalor" type="text" class="form-control" disabled="disabled">              
                            </div>
                        </div>    
                        ...
                        <div class="col-xs-12 col-sm-12">  
                            <div class="form-group">
                                ...
                                <textarea id="txtobservacion" name="txtobservacion" class="form-control" disabled="disabled"></textarea>          
                            </div>
                        </div>                       
